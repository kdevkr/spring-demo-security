	...
	<div class="container-fluid">
		...
		<sec:csrfInput />
		  ...
		  <div class="form-group">
		    ...
		    <input type="text" name="phoneNumber" class="form-control" placeholder="01012345678" pattern="^01(?:0|1[6-9])(?:\d{3}|\d{4})\d{4}$" data-error="전화번호 형식이 아닙니다." required>
		    <div class="help-block with-errors"></div>
		  </div>
		  <div class="form-group">
		    <label class="radio-inline">
			  <input type="radio" name="role" value="ROLE_USER" checked="checked" readonly> 일반 사용자
			</label>
		  </div>
		  <div class="form-group">
			<label class="checkbox-inline">
			  <input type="checkbox" name="role" value="ROLE_BLOG"> 블로그 권한 부여
			</label>
			<label class="checkbox-inline">
			  <input type="checkbox" name="role" value="ROLE_API"> 오픈 API 권한 부여
			</label>
		  </div>
